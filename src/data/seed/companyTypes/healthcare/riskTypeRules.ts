/**
 * RISK TYPE RULES SEED DATA
 * Automated tagging rules that fire when source objects match a filter condition.
 * autoCreate: true → tag is created automatically; false → suggested to user for manual acceptance.
 */
