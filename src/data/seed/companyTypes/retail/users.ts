...
export const users: User[] = [
  ...
  // user-009: Bridget O'Sullivan — Director of Construction
  {
    ...
    lastName: "O'Sullivan",
    companyName: 'Brightline Retail Group',
    email: 'bridget.osullivan@brg.com',
