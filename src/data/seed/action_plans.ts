...
export const actionPlans: ActionPlan[] = [
  ...
  { id:'ap-003d', accountId:'acc-001', projectId:'proj-003', number:4, title:'Construction Phase Oversight', typeId:'apt-003', status:'in_progress', private:false, locationId:null, description:'Ongoing construction phase oversight for Mercy MOB Phase II.', planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl004InProgressSections('ap-003d','2023-11-01','2026-04-02',false), createdBy:'user-009', createdAt:d('2023-11-01'), updatedAt:d('2026-03-28') },
  ...
  { id:'ap-004c', accountId:'acc-001', projectId:'proj-004', number:3, title:'Preconstruction Checklist', typeId:'apt-002', status:'in_progress', private:false, locationId:null, description:'Preconstruction activities underway — contract executed, site readiness in progress.', planManager:'user-008', approvers:['user-009'], completedReceivers:['user-010','user-011'], sections:tpl003InProgressSections('ap-004c','2024-04-15','2026-03-30'), createdBy:'user-008', createdAt:d('2024-04-15'), updatedAt:d('2026-03-28') },
  ...
  { id:'ap-005d', accountId:'acc-001', projectId:'proj-005', number:4, title:'Construction Phase Oversight', typeId:'apt-003', status:'in_progress', private:false, locationId:null, description:'Construction phase oversight — delayed items in infection control compliance.', planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl004InProgressSections('ap-005d','2023-07-01','2026-04-07',true), createdBy:'user-009', createdAt:d('2023-07-01'), updatedAt:d('2026-04-04') },
  ...
  { id:'ap-006b', accountId:'acc-001', projectId:'proj-006', number:2, title:'Design & Permitting Readiness', typeId:'apt-006', status:'in_progress', private:false, locationId:null, description:'Design and permitting readiness underway — CDs in final review.', planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl002InProgressSections('ap-006b','2024-03-01','2026-04-03'), createdBy:'user-009', createdAt:d('2024-03-01'), updatedAt:d('2026-04-01') },
  ...
  { id:'ap-008c', accountId:'acc-001', projectId:'proj-008', number:3, title:'Preconstruction Checklist', typeId:'apt-002', status:'in_progress', private:false, locationId:null, description:'Preconstruction checklist in progress — contract in negotiation.', planManager:'user-008', approvers:['user-009'], completedReceivers:['user-010','user-011'], sections:tpl003InProgressSections('ap-008c','2024-06-15','2026-03-28'), createdBy:'user-008', createdAt:d('2024-06-15'), updatedAt:d('2026-03-25') },
  ...
  { id:'ap-009d', accountId:'acc-001', projectId:'proj-009', number:4, title:'Construction Phase Oversight', typeId:'apt-003', status:'in_progress', private:false, locationId:null, description:"Ongoing construction oversight for St. Vincent's OR renovation.", planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl004InProgressSections('ap-009d','2024-02-01','2026-04-06',false), createdBy:'user-009', createdAt:d('2024-02-01'), updatedAt:d('2026-04-03') },
  ...
  { id:'ap-010b', accountId:'acc-001', projectId:'proj-010', number:2, title:'Design & Permitting Readiness', typeId:'apt-006', status:'in_progress', private:false, locationId:null, description:'Permit application submitted — state health review pending.', planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl002InProgressSections('ap-010b','2024-07-01','2026-04-01'), createdBy:'user-009', createdAt:d('2024-07-01'), updatedAt:d('2026-03-30') },
  ...
  { id:'ap-011a', accountId:'acc-001', projectId:'proj-011', number:1, title:'Feasibility & Funding Gate', typeId:'apt-001', status:'draft', private:false, locationId:null, description:'On hold pending federal grant award — feasibility gate only partially complete.', planManager:null, approvers:['user-001','user-007'], completedReceivers:['user-004'],
    sections:[
      { id:'ap-011a-s1', planId:'ap-011a', title:'Needs Assessment & Business Case', order:0, createdAt:d('2023-01-15'), updatedAt:d('2023-06-01'), items:[
        ...
        inProgressItem('ap-011a-s1-i2','ap-011a-s1',1,'Preliminary project scope defined',['user-008'],'2026-04-04','user-008','2023-01-15'),
  ...
  { id:'ap-012b', accountId:'acc-001', projectId:'proj-012', number:2, title:'Design & Permitting Readiness', typeId:'apt-006', status:'draft', private:false, locationId:null, description:'CDs complete but permit submission paused due to budget reallocation.', planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl002InProgressSections('ap-012b','2023-08-01','2026-04-08'), createdBy:'user-009', createdAt:d('2023-08-01'), updatedAt:d('2023-11-01') },
  ...
  { id:'ap-013c', accountId:'acc-001', projectId:'proj-013', number:3, title:'Preconstruction Checklist', typeId:'apt-002', status:'draft', private:false, locationId:null, description:'Stalled — project on hold pending zoning variance and environmental review.', planManager:null, approvers:['user-009'], completedReceivers:['user-010'], sections:tpl003InProgressSections('ap-013c','2024-01-01','2026-04-06'), createdBy:'user-008', createdAt:d('2024-01-01'), updatedAt:d('2024-02-01') },
  ...
  { id:'ap-014b', accountId:'acc-001', projectId:'proj-014', number:2, title:'Design & Permitting Readiness', typeId:'apt-006', status:'draft', private:false, locationId:null, description:'Permit submission paused pending MRI equipment procurement lead time resolution.', planManager:'user-009', approvers:['user-008'], completedReceivers:['user-010'], sections:tpl002InProgressSections('ap-014b','2024-04-01','2026-04-02'), createdBy:'user-009', createdAt:d('2024-04-01'), updatedAt:d('2024-07-01') },
  ...
  { id:'ap-019a', accountId:'acc-001', projectId:'proj-019', number:1, title:'Feasibility & Funding Gate', typeId:'apt-001', status:'draft', private:false, locationId:null, description:'Cancelled following FAA airspace review denial — gate was never completed.', planManager:null, approvers:['user-001'], completedReceivers:[],
    sections:[
      { id:'ap-019a-s1', planId:'ap-019a', title:'Needs Assessment & Business Case', order:0, createdAt:d('2023-10-01'), updatedAt:d('2023-10-01'), items:[
        inProgressItem('ap-019a-s1-i1','ap-019a-s1',0,'Clinical needs assessment completed',['user-006'],'2026-03-29','user-008','2023-10-01'),
  ...
  { id:'ap-020a', accountId:'acc-001', projectId:'proj-020', number:1, title:'Feasibility & Funding Gate', typeId:'apt-001', status:'draft', private:false, locationId:null, description:'Cancelled when lease negotiations fell through — feasibility gate only partially complete.', planManager:null, approvers:['user-001'], completedReceivers:[],
    sections:[
      { id:'ap-020a-s1', planId:'ap-020a', title:'Needs Assessment & Business Case', order:0, createdAt:d('2024-01-01'), updatedAt:d('2024-01-01'), items:[
        ...
        inProgressItem('ap-020a-s1-i2','ap-020a-s1',1,'Preliminary project scope defined',['user-008'],'2026-03-27','user-008','2024-01-01'),
