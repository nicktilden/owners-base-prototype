/**
 * APPROVAL TRIGGERS SEED DATA
 * Defines conditions under which a risk tag escalates to a Procore Workflow for approval.
 * When the trigger condition is met on a tagged item, the tag transitions to 'pending_approval'.
 */
