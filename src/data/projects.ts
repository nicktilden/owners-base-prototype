...
export interface ProjectRow {
  ...
  number: string;
  favorite: boolean;
  /** Street address line (e.g. "21715 Filigree Ct"). */
  streetAddress?: string;
  /** City, ST ZIP — shown on the second line of the Location column. */
  location: string;
...
const SAMPLE_PROJECT_ROWS_BASE: Omit<ProjectRow, "city" | "state" | "favorite" | "region" | "projectManager">[] = [
  { id: 1,  name: "Northern Virginia Data Center Phase 2",   number: `${REGIONS[0]}-${PROJECT_NUMBERS[0]}`,   streetAddress: "21715 Filigree Ct",            location: "Ashburn, VA 20147",          stage: SAMPLE_STAGES[0],  startDate: "2024-01-08", endDate: "2025-09-30", program: "Data Center",    estimatedCost: 185000000,   originalBudget: 178000000,   jobToDateCost: 92000000,  forecastToComplete: 187000000,   estimatedCostAtCompletion: 187000000,   priorities: "Schedule, Budget",   priority: "high"   },
  { id: 2,  name: "Ohio Region Campus Expansion",            number: `${REGIONS[1]}-${PROJECT_NUMBERS[1]}`,   streetAddress: "850 Twin Rivers Dr",           location: "Columbus, OH 43215",         stage: SAMPLE_STAGES[1],  startDate: "2024-02-01", endDate: "2025-11-15", program: "Data Center",    estimatedCost: 220000000,   originalBudget: 215000000,   jobToDateCost: 88000000,  forecastToComplete: 222000000,   estimatedCostAtCompletion: 222000000,   priorities: "Safety, Schedule",   priority: "high"   },
  { id: 3,  name: "Roastery Chicago",                        number: `${REGIONS[2]}-${PROJECT_NUMBERS[2]}`,   streetAddress: "100 W Kinzie St",              location: "Chicago, IL 60654",          stage: SAMPLE_STAGES[2],  startDate: "2024-01-15", endDate: "2025-06-30", program: "Retail",         estimatedCost: 28500000,    originalBudget: 27200000,    jobToDateCost: 14200000,  forecastToComplete: 28800000,    estimatedCostAtCompletion: 28800000,    priorities: "Quality, Schedule",  priority: "medium" },
  { id: 4,  name: "Drive-Thru Store Prototype Phoenix",      number: `${REGIONS[3]}-${PROJECT_NUMBERS[3]}`,   streetAddress: "401 W Washington St",          location: "Phoenix, AZ 85004",          stage: SAMPLE_STAGES[3],  startDate: "2024-03-01", endDate: "2024-12-15", program: "Retail",         estimatedCost: 3200000,     originalBudget: 3050000,     jobToDateCost: 1800000,   forecastToComplete: 3180000,     estimatedCostAtCompletion: 3180000,     priorities: "Budget",             priority: "low"    },
  { id: 5,  name: "Atlanta Data Hall 3 Buildout",            number: `${REGIONS[4]}-${PROJECT_NUMBERS[4]}`,   streetAddress: "1301 Ellsworth Industrial Blvd",location: "Atlanta, GA 30318",          stage: SAMPLE_STAGES[4],  startDate: "2024-02-15", endDate: "2025-04-30", program: "Data Center",    estimatedCost: 42000000,    originalBudget: 40500000,    jobToDateCost: 21000000,  forecastToComplete: 41800000,    estimatedCostAtCompletion: 41800000,    priorities: "Schedule",           priority: "medium" },
  { id: 6,  name: "Dallas Critical Facility Upgrade",        number: `${REGIONS[5]}-${PROJECT_NUMBERS[5]}`,   streetAddress: "12404 Park Central Dr",        location: "Dallas, TX 75244",           stage: SAMPLE_STAGES[5],  startDate: "2024-05-01", endDate: "2026-01-31", program: "Data Center",    estimatedCost: 68000000,    originalBudget: 65000000,    jobToDateCost: 4200000,   forecastToComplete: 67500000,    estimatedCostAtCompletion: 67500000,    priorities: "Budget, Quality",    priority: "medium" },
  { id: 7,  name: "Denver HQ Fit-Out",                       number: `${REGIONS[6]}-${PROJECT_NUMBERS[6]}`,   streetAddress: "1700 Lincoln St",              location: "Denver, CO 80202",           stage: SAMPLE_STAGES[6],  startDate: "2024-06-01", endDate: "2025-08-31", program: "Commercial",     estimatedCost: 8500000,     originalBudget: 8200000,     jobToDateCost: 0,         forecastToComplete: 8600000,     estimatedCostAtCompletion: 8600000,     priorities: "Quality",            priority: "low"    },
  { id: 8,  name: "Retail Pads Austin Phase 1",              number: `${REGIONS[7]}-${PROJECT_NUMBERS[7]}`,   streetAddress: "9300 Research Blvd",           location: "Austin, TX 78758",           stage: SAMPLE_STAGES[7],  startDate: "2024-01-20", endDate: "2025-03-15", program: "Commercial",     estimatedCost: 12500000,    originalBudget: 12000000,    jobToDateCost: 6200000,   forecastToComplete: 12400000,    estimatedCostAtCompletion: 12400000,    priorities: "Schedule",           priority: "medium" },
  { id: 9,  name: "Supercenter Grand Rapids",                number: `${REGIONS[8]}-${PROJECT_NUMBERS[8]}`,   streetAddress: "4747 28th St SE",              location: "Grand Rapids, MI 49503",     stage: SAMPLE_STAGES[8],  startDate: "2024-02-10", endDate: "2025-07-31", program: "Retail",         estimatedCost: 18500000,    originalBudget: 17800000,    jobToDateCost: 7400000,   forecastToComplete: 18600000,    estimatedCostAtCompletion: 18600000,    priorities: "Safety, Budget",     priority: "medium" },
  { id: 10, name: "Buffalo Substation Upgrade",              number: `${REGIONS[9]}-${PROJECT_NUMBERS[9]}`,   streetAddress: "200 Delaware Ave",             location: "Buffalo, NY 14202",          stage: SAMPLE_STAGES[9],  startDate: "2024-01-05", endDate: "2025-12-20", program: "Infrastructure", estimatedCost: 42000000,    originalBudget: 40000000,    jobToDateCost: 16800000,  forecastToComplete: 42500000,    estimatedCostAtCompletion: 42500000,    priorities: "Safety, Schedule",   priority: "high"   },
  { id: 11, name: "Store Orlando",                           number: `${REGIONS[10]}-${PROJECT_NUMBERS[10]}`, streetAddress: "5301 Adanson St",              location: "Orlando, FL 32822",          stage: SAMPLE_STAGES[10], startDate: "2024-03-15", endDate: "2025-05-30", program: "Retail",         estimatedCost: 12500000,    originalBudget: 12200000,    jobToDateCost: 5000000,   forecastToComplete: 12600000,    estimatedCostAtCompletion: 12600000,    priorities: "Schedule",           priority: "low"    },
  { id: 12, name: "St. Mary's ED Expansion",                 number: `${REGIONS[11]}-${PROJECT_NUMBERS[11]}`, streetAddress: "1840 Wealthy St SE",           location: "Grand Rapids, MI 49503",     stage: SAMPLE_STAGES[11], startDate: "2024-02-01", endDate: "2025-10-31", program: "Healthcare",     estimatedCost: 38000000,    originalBudget: 36500000,    jobToDateCost: 15200000,  forecastToComplete: 38200000,    estimatedCostAtCompletion: 38200000,    priorities: "Safety, Quality",    priority: "high"   },
  { id: 13, name: "Oregon Region Power & Cooling",           number: `${REGIONS[12]}-${PROJECT_NUMBERS[12]}`, streetAddress: "73500 Disher Rd",              location: "Boardman, OR 97818",         stage: SAMPLE_STAGES[12], startDate: "2024-07-01", endDate: "2026-06-30", program: "Data Center",    estimatedCost: 95000000,    originalBudget: 91000000,    jobToDateCost: 5800000,   forecastToComplete: 95200000,    estimatedCostAtCompletion: 95200000,    priorities: "Budget",             priority: "medium" },
  { id: 14, name: "Support Center Seattle Renovation",       number: `${REGIONS[13]}-${PROJECT_NUMBERS[13]}`, streetAddress: "2401 Utah Ave S",              location: "Seattle, WA 98134",          stage: SAMPLE_STAGES[13], startDate: "2024-08-01", endDate: "2026-02-28", program: "Commercial",     estimatedCost: 22000000,    originalBudget: 21000000,    jobToDateCost: 0,         forecastToComplete: 21800000,    estimatedCostAtCompletion: 21800000,    priorities: "Quality",            priority: "low"    },
  { id: 15, name: "Chicago Meet-Me Room Expansion",          number: `${REGIONS[14]}-${PROJECT_NUMBERS[14]}`, streetAddress: "350 N Orleans St",             location: "Chicago, IL 60601",          stage: SAMPLE_STAGES[14], startDate: "2024-04-01", endDate: "2025-02-28", program: "Data Center",    estimatedCost: 12000000,    originalBudget: 11500000,    jobToDateCost: 3600000,   forecastToComplete: 11900000,    estimatedCostAtCompletion: 11900000,    priorities: "Schedule",           priority: "medium" },
  { id: 16, name: "Houston Office",                          number: `${REGIONS[15]}-${PROJECT_NUMBERS[15]}`, streetAddress: "1200 Smith St",                location: "Houston, TX 77002",          stage: SAMPLE_STAGES[15], startDate: "2024-09-01", endDate: "2026-03-31", program: "Commercial",     estimatedCost: 6200000,     originalBudget: 6000000,     jobToDateCost: 0,         forecastToComplete: 6150000,     estimatedCostAtCompletion: 6150000,     priorities: "Budget",             priority: "low"    },
  { id: 17, name: "Multifamily Nashville",                   number: `${REGIONS[16]}-${PROJECT_NUMBERS[16]}`, streetAddress: "900 Rosa L Parks Blvd",        location: "Nashville, TN 37203",        stage: SAMPLE_STAGES[16], startDate: "2024-01-10", endDate: "2025-11-30", program: "Residential",    estimatedCost: 28500000,    originalBudget: 27200000,    jobToDateCost: 11400000,  forecastToComplete: 28600000,    estimatedCostAtCompletion: 28600000,    priorities: "Schedule, Quality",  priority: "medium" },
  { id: 18, name: "Distribution Center Toledo",              number: `${REGIONS[17]}-${PROJECT_NUMBERS[17]}`, streetAddress: "4301 Stickney Ave",            location: "Toledo, OH 43608",           stage: SAMPLE_STAGES[17], startDate: "2024-06-15", endDate: "2026-04-30", program: "Industrial",     estimatedCost: 95000000,    originalBudget: 90000000,    jobToDateCost: 7200000,   forecastToComplete: 94800000,    estimatedCostAtCompletion: 94800000,    priorities: "Budget, Schedule",   priority: "medium" },
  { id: 19, name: "Boston Gas Main Replacement",             number: `${REGIONS[18]}-${PROJECT_NUMBERS[18]}`, streetAddress: "1 City Hall Plaza",            location: "Boston, MA 02108",           stage: SAMPLE_STAGES[18], startDate: "2024-02-20", endDate: "2025-08-15", program: "Infrastructure", estimatedCost: 18500000,    originalBudget: 17800000,    jobToDateCost: 5550000,   forecastToComplete: 18600000,    estimatedCostAtCompletion: 18600000,    priorities: "Safety",             priority: "high"   },
  { id: 20, name: "Fulfillment Center Atlanta",              number: `${REGIONS[19]}-${PROJECT_NUMBERS[19]}`, streetAddress: "5000 Fulton Industrial Blvd",  location: "Atlanta, GA 30336",          stage: SAMPLE_STAGES[19], startDate: "2024-01-12", endDate: "2025-09-30", program: "Industrial",     estimatedCost: 125000000,   originalBudget: 120000000,   jobToDateCost: 62500000,  forecastToComplete: 124000000,   estimatedCostAtCompletion: 124000000,   priorities: "Schedule",           priority: "high"   },
  { id: 21, name: "Mercy Campus OR Renovation",              number: `${REGIONS[20]}-${PROJECT_NUMBERS[20]}`, streetAddress: "1700 Clinton St",              location: "Muskegon, MI 49444",         stage: SAMPLE_STAGES[20], startDate: "2024-03-01", endDate: "2025-12-15", program: "Healthcare",     estimatedCost: 22000000,    originalBudget: 21200000,    jobToDateCost: 6600000,   forecastToComplete: 22100000,    estimatedCostAtCompletion: 22100000,    priorities: "Quality, Safety",    priority: "medium" },
  { id: 22, name: "San Francisco Bay Area Office",           number: `${REGIONS[21]}-${PROJECT_NUMBERS[21]}`, streetAddress: "188 Beale St",                 location: "San Francisco, CA 94105",    stage: SAMPLE_STAGES[21], startDate: "2024-05-01", endDate: "2026-01-31", program: "Commercial",     estimatedCost: 45000000,    originalBudget: 43200000,    jobToDateCost: 1800000,   forecastToComplete: 44800000,    estimatedCostAtCompletion: 44800000,    priorities: "Quality",            priority: "medium" },
  { id: 23, name: "Reserve Store Miami",                     number: `${REGIONS[22]}-${PROJECT_NUMBERS[22]}`, streetAddress: "1100 5th St",                  location: "Miami, FL 33139",            stage: SAMPLE_STAGES[22], startDate: "2024-04-10", endDate: "2025-01-31", program: "Retail",         estimatedCost: 4800000,     originalBudget: 4600000,     jobToDateCost: 1920000,   forecastToComplete: 4780000,     estimatedCostAtCompletion: 4780000,     priorities: "Schedule",           priority: "low"    },
  { id: 24, name: "NYC Metro Edge Site",                     number: `${REGIONS[23]}-${PROJECT_NUMBERS[23]}`, streetAddress: "300 Metro Blvd",               location: "Secaucus, NJ 07094",         stage: SAMPLE_STAGES[23], startDate: "2024-10-01", endDate: "2026-08-31", program: "Data Center",    estimatedCost: 78000000,    originalBudget: 75000000,    jobToDateCost: 0,         forecastToComplete: 77500000,    estimatedCostAtCompletion: 77500000,    priorities: "Budget",             priority: "medium" },
  { id: 25, name: "Atlanta Client Fit-Out",                  number: `${REGIONS[24]}-${PROJECT_NUMBERS[24]}`, streetAddress: "270 Peachtree St NW",          location: "Atlanta, GA 30308",          stage: SAMPLE_STAGES[24], startDate: "2024-02-01", endDate: "2024-11-30", program: "Commercial",     estimatedCost: 4200000,     originalBudget: 4050000,     jobToDateCost: 1680000,   forecastToComplete: 4180000,     estimatedCostAtCompletion: 4180000,     priorities: "Schedule",           priority: "low"    },
  { id: 26, name: "Industrial Shell Dallas",                 number: `${REGIONS[25]}-${PROJECT_NUMBERS[25]}`, streetAddress: "16000 N Dallas Pkwy",          location: "Dallas, TX 75240",           stage: SAMPLE_STAGES[25], startDate: "2024-01-25", endDate: "2025-05-15", program: "Industrial",     estimatedCost: 18500000,    originalBudget: 17800000,    jobToDateCost: 7400000,   forecastToComplete: 18400000,    estimatedCostAtCompletion: 18400000,    priorities: "Budget",             priority: "low"    },
  { id: 27, name: "Supercenter Indianapolis",                number: `${REGIONS[26]}-${PROJECT_NUMBERS[26]}`, streetAddress: "8060 Castleton Rd",            location: "Indianapolis, IN 46250",     stage: SAMPLE_STAGES[26], startDate: "2024-07-01", endDate: "2026-02-28", program: "Retail",         estimatedCost: 19200000,    originalBudget: 18500000,    jobToDateCost: 960000,    forecastToComplete: 19100000,    estimatedCostAtCompletion: 19100000,    priorities: "Schedule",           priority: "medium" },
  { id: 28, name: "Upstate NY Transmission",                 number: `${REGIONS[27]}-${PROJECT_NUMBERS[27]}`, streetAddress: "800 W Genesee St",             location: "Syracuse, NY 13202",         stage: SAMPLE_STAGES[27], startDate: "2024-01-15", endDate: "2026-06-30", program: "Infrastructure", estimatedCost: 125000000,   originalBudget: 118000000,   jobToDateCost: 37500000,  forecastToComplete: 124000000,   estimatedCostAtCompletion: 124000000,   priorities: "Safety, Schedule",   priority: "high"   },
  { id: 29, name: "Store Minneapolis",                       number: `${REGIONS[28]}-${PROJECT_NUMBERS[28]}`, streetAddress: "7900 Xerxes Ave S",            location: "Minneapolis, MN 55425",      stage: SAMPLE_STAGES[28], startDate: "2024-04-01", endDate: "2025-06-30", program: "Retail",         estimatedCost: 11800000,    originalBudget: 11400000,    jobToDateCost: 3540000,   forecastToComplete: 11700000,    estimatedCostAtCompletion: 11700000,    priorities: "Budget",             priority: "low"    },
  { id: 30, name: "Outpatient Pavilion Lansing",             number: `${REGIONS[29]}-${PROJECT_NUMBERS[29]}`, streetAddress: "2900 Hannah Blvd",             location: "Lansing, MI 48912",          stage: SAMPLE_STAGES[29], startDate: "2024-08-15", endDate: "2026-09-30", program: "Healthcare",     estimatedCost: 68000000,    originalBudget: 65000000,    jobToDateCost: 0,         forecastToComplete: 67500000,    estimatedCostAtCompletion: 67500000,    priorities: "Quality",            priority: "medium" },
  { id: 31, name: "Virginia Solar + BESS",                   number: `${REGIONS[30]}-${PROJECT_NUMBERS[30]}`, streetAddress: "23455 Autopilot Dr",           location: "Dulles, VA 20166",           stage: SAMPLE_STAGES[30], startDate: "2024-11-01", endDate: "2026-12-31", program: "Infrastructure", estimatedCost: 52000000,    originalBudget: 50000000,    jobToDateCost: 0,         forecastToComplete: 51800000,    estimatedCostAtCompletion: 51800000,    priorities: "Budget",             priority: "low"    },
  { id: 32, name: "Distribution Center Dallas",              number: `${REGIONS[31]}-${PROJECT_NUMBERS[31]}`, streetAddress: "2400 S Loop 12",               location: "Dallas, TX 75241",           stage: SAMPLE_STAGES[31], startDate: "2024-02-15", endDate: "2025-10-31", program: "Industrial",     estimatedCost: 85000000,    originalBudget: 82000000,    jobToDateCost: 34000000,  forecastToComplete: 84800000,    estimatedCostAtCompletion: 84800000,    priorities: "Schedule",           priority: "high"   },
  { id: 33, name: "Phoenix Data Hall 1",                     number: `${REGIONS[32]}-${PROJECT_NUMBERS[32]}`, streetAddress: "4500 E McDowell Rd",           location: "Phoenix, AZ 85034",          stage: SAMPLE_STAGES[32], startDate: "2024-03-10", endDate: "2025-07-31", program: "Data Center",    estimatedCost: 38000000,    originalBudget: 36500000,    jobToDateCost: 11400000,  forecastToComplete: 37800000,    estimatedCostAtCompletion: 37800000,    priorities: "Schedule",           priority: "medium" },
  { id: 34, name: "Office Building Charlotte",               number: `${REGIONS[33]}-${PROJECT_NUMBERS[33]}`, streetAddress: "401 N Tryon St",               location: "Charlotte, NC 28202",        stage: SAMPLE_STAGES[33], startDate: "2024-01-08", endDate: "2025-08-30", program: "Commercial",     estimatedCost: 42000000,    originalBudget: 40500000,    jobToDateCost: 16800000,  forecastToComplete: 42200000,    estimatedCostAtCompletion: 42200000,    priorities: "Quality",            priority: "medium" },
  { id: 35, name: "Fuel Station & Convenience Detroit",      number: `${REGIONS[34]}-${PROJECT_NUMBERS[34]}`, streetAddress: "1400 Woodward Ave",            location: "Detroit, MI 48201",          stage: SAMPLE_STAGES[34], startDate: "2024-05-01", endDate: "2024-12-20", program: "Retail",         estimatedCost: 3200000,     originalBudget: 3080000,     jobToDateCost: 960000,    forecastToComplete: 3180000,     estimatedCostAtCompletion: 3180000,     priorities: "Budget",             priority: "low"    },
  { id: 36, name: "Rhode Island Substation",                 number: `${REGIONS[35]}-${PROJECT_NUMBERS[35]}`, streetAddress: "89 Jefferson Blvd",            location: "Providence, RI 02903",       stage: SAMPLE_STAGES[35], startDate: "2024-07-15", endDate: "2026-05-31", program: "Infrastructure", estimatedCost: 35000000,    originalBudget: 33500000,    jobToDateCost: 2100000,   forecastToComplete: 34800000,    estimatedCostAtCompletion: 34800000,    priorities: "Safety",             priority: "high"   },
  { id: 37, name: "Store Denver",                            number: `${REGIONS[36]}-${PROJECT_NUMBERS[36]}`, streetAddress: "3900 E Mexico Ave",            location: "Denver, CO 80222",           stage: SAMPLE_STAGES[36], startDate: "2024-04-20", endDate: "2025-07-15", program: "Retail",         estimatedCost: 12200000,    originalBudget: 11800000,    jobToDateCost: 3660000,   forecastToComplete: 12100000,    estimatedCostAtCompletion: 12100000,    priorities: "Schedule",           priority: "low"    },
  { id: 38, name: "Imaging Center Ann Arbor",                number: `${REGIONS[37]}-${PROJECT_NUMBERS[37]}`, streetAddress: "4990 Clark Rd",                location: "Ann Arbor, MI 48105",        stage: SAMPLE_STAGES[37], startDate: "2024-03-15", endDate: "2025-04-30", program: "Healthcare",     estimatedCost: 12500000,    originalBudget: 12000000,    jobToDateCost: 5000000,   forecastToComplete: 12400000,    estimatedCostAtCompletion: 12400000,    priorities: "Quality",            priority: "low"    },
  { id: 39, name: "Texas Region Data Center",                number: `${REGIONS[38]}-${PROJECT_NUMBERS[38]}`, streetAddress: "9725 Datapoint Dr",            location: "San Antonio, TX 78216",      stage: SAMPLE_STAGES[38], startDate: "2024-02-01", endDate: "2025-12-15", program: "Data Center",    estimatedCost: 195000000,   originalBudget: 188000000,   jobToDateCost: 78000000,  forecastToComplete: 196000000,   estimatedCostAtCompletion: 196000000,   priorities: "Schedule",           priority: "high"   },
  { id: 40, name: "Store Las Vegas",                         number: `${REGIONS[39]}-${PROJECT_NUMBERS[39]}`, streetAddress: "3663 Las Vegas Blvd S",        location: "Las Vegas, NV 89109",        stage: SAMPLE_STAGES[39], startDate: "2024-05-15", endDate: "2024-11-30", program: "Retail",         estimatedCost: 2850000,     originalBudget: 2720000,     jobToDateCost: 855000,    forecastToComplete: 2820000,     estimatedCostAtCompletion: 2820000,     priorities: "Budget",             priority: "low"    },
  { id: 41, name: "Salt Lake City Buildout",                 number: `${REGIONS[40]}-${PROJECT_NUMBERS[40]}`, streetAddress: "1400 W North Temple",          location: "Salt Lake City, UT 84116",   stage: SAMPLE_STAGES[40], startDate: "2024-09-01", endDate: "2026-06-30", program: "Data Center",    estimatedCost: 55000000,    originalBudget: 52800000,    jobToDateCost: 0,         forecastToComplete: 54800000,    estimatedCostAtCompletion: 54800000,    priorities: "Budget",             priority: "medium" },
  { id: 42, name: "Phoenix Office",                          number: `${REGIONS[41]}-${PROJECT_NUMBERS[41]}`, streetAddress: "502 W Washington St",          location: "Phoenix, AZ 85004",          stage: SAMPLE_STAGES[41], startDate: "2024-06-15", endDate: "2025-12-31", program: "Commercial",     estimatedCost: 5800000,     originalBudget: 5600000,     jobToDateCost: 0,         forecastToComplete: 5750000,     estimatedCostAtCompletion: 5750000,     priorities: "Quality",            priority: "low"    },
  { id: 43, name: "Mixed-Use Raleigh",                       number: `${REGIONS[42]}-${PROJECT_NUMBERS[42]}`, streetAddress: "100 S Harrington St",          location: "Raleigh, NC 27601",          stage: SAMPLE_STAGES[42], startDate: "2024-08-01", endDate: "2026-11-30", program: "Commercial",     estimatedCost: 72000000,    originalBudget: 69000000,    jobToDateCost: 4320000,   forecastToComplete: 71800000,    estimatedCostAtCompletion: 71800000,    priorities: "Schedule",           priority: "medium" },
  { id: 44, name: "Supercenter Cincinnati",                  number: `${REGIONS[43]}-${PROJECT_NUMBERS[43]}`, streetAddress: "11252 Lebanon Rd",             location: "Cincinnati, OH 45240",       stage: SAMPLE_STAGES[43], startDate: "2024-03-01", endDate: "2025-08-31", program: "Retail",         estimatedCost: 18800000,    originalBudget: 18100000,    jobToDateCost: 5640000,   forecastToComplete: 18700000,    estimatedCostAtCompletion: 18700000,    priorities: "Safety",             priority: "medium" },
  { id: 45, name: "Brooklyn Network Upgrade",                number: `${REGIONS[44]}-${PROJECT_NUMBERS[44]}`, streetAddress: "360 Jay St",                   location: "Brooklyn, NY 11201",         stage: SAMPLE_STAGES[44], startDate: "2024-01-22", endDate: "2025-09-15", program: "Infrastructure", estimatedCost: 28000000,    originalBudget: 26800000,    jobToDateCost: 8400000,   forecastToComplete: 27900000,    estimatedCostAtCompletion: 27900000,    priorities: "Safety, Schedule",   priority: "high"   },
  { id: 46, name: "Store San Diego",                         number: `${REGIONS[45]}-${PROJECT_NUMBERS[45]}`, streetAddress: "2415 Camino Del Rio N",        location: "San Diego, CA 92108",        stage: SAMPLE_STAGES[45], startDate: "2024-04-05", endDate: "2025-05-20", program: "Retail",         estimatedCost: 11500000,    originalBudget: 11100000,    jobToDateCost: 3450000,   forecastToComplete: 11400000,    estimatedCostAtCompletion: 11400000,    priorities: "Schedule",           priority: "low"    },
  { id: 47, name: "Medical Office Building Port Huron",      number: `${REGIONS[46]}-${PROJECT_NUMBERS[46]}`, streetAddress: "2601 Electric Ave",            location: "Port Huron, MI 48060",       stage: SAMPLE_STAGES[46], startDate: "2024-02-10", endDate: "2025-11-30", program: "Healthcare",     estimatedCost: 18500000,    originalBudget: 17800000,    jobToDateCost: 7400000,   forecastToComplete: 18400000,    estimatedCostAtCompletion: 18400000,    priorities: "Quality",            priority: "low"    },
  { id: 48, name: "Virginia HQ2 Phase 2",                    number: `${REGIONS[47]}-${PROJECT_NUMBERS[47]}`, streetAddress: "241 18th St S",                location: "Arlington, VA 22202",        stage: SAMPLE_STAGES[47], startDate: "2024-01-01", endDate: "2026-06-30", program: "Commercial",     estimatedCost: 2500000000,  originalBudget: 2400000000,  jobToDateCost: 625000000, forecastToComplete: 2490000000,  estimatedCostAtCompletion: 2490000000,  priorities: "Schedule, Quality",  priority: "high"   },
  { id: 49, name: "Farmer Support Center Expansion",         number: `${REGIONS[48]}-${PROJECT_NUMBERS[48]}`, streetAddress: "Rohrmoser, Distrito Pavas",     location: "San José, Costa Rica",       stage: SAMPLE_STAGES[48], startDate: "2024-07-01", endDate: "2026-03-31", program: "Commercial",     estimatedCost: 12000000,    originalBudget: 11500000,    jobToDateCost: 0,         forecastToComplete: 11900000,    estimatedCostAtCompletion: 11900000,    priorities: "Quality",            priority: "low"    },
  { id: 50, name: "Miami Critical Load Upgrade",             number: `${REGIONS[49]}-${PROJECT_NUMBERS[49]}`, streetAddress: "7265 NW 25th St",              location: "Miami, FL 33122",            stage: SAMPLE_STAGES[49], startDate: "2024-04-01", endDate: "2025-06-30", program: "Data Center",    estimatedCost: 22000000,    originalBudget: 21200000,    jobToDateCost: 6600000,   forecastToComplete: 21900000,    estimatedCostAtCompletion: 21900000,    priorities: "Schedule",           priority: "medium" },
];

const _connectionsById = new Map<number, ProjectConnection>(
...
/** Distinct project manager names in alphabetical order. */
export const PROJECT_MANAGER_NAMES: string[] = [
  ...new Set(sampleProjectRows.map((r) => r.projectManager)),
].sort();

/** Distinct geographic region values in alphabetical order. */
export const PROJECT_REGION_NAMES: ProjectRegion[] = [
  ...new Set(sampleProjectRows.map((r) => r.region)),
].sort() as ProjectRegion[];
...
/**
 * Last/next milestone labels and schedule variance (days) for a portfolio row.
 * Matches the Projects hub grid (`portfolioColumnDefs` computed columns).
 */
export function getProjectPortfolioScheduleSummary(row: ProjectRow): {
  ...
  const variance =
    scheduleVarianceData.find((d) => d.project === row.name)?.variance ?? 0;
  return {
