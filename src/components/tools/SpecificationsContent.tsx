...
import {
  NotepadPencil as SpecificationsIcon,
  Filter,
  Plus,
  Sliders,
...
import { specificationSections } from "@/data/seed/specifications";
...
export default function SpecificationsContent({ projectId }: SpecificationsContentProps) {
  ...
  const rowData = useMemo(() => specificationSections.filter((s) => s.projectId === projectId), [projectId]);
