...
const TearsheetWidth = createGlobalStyle`
  [class*="StyledTearsheetBody"]:has(> .corr-detail-tearsheet-root) {
...
export default function CorrespondenceDetailTearsheet({ item, open, onClose }: Props) {
  ...
  return (
    <>
      <TearsheetWidth />
      <Tearsheet open={open} onClose={onClose} aria-label="Correspondence details" placement="right">
        <div className="corr-detail-tearsheet-root" style={{ display: "flex", flexDirection: "column", height: "100%" }}>
              ...
              <Page.Header style={{ background: "var(--color-surface-primary)", borderColor: "var(--color-border-separator)" }}>
                <Page.Title>
                  <Box style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography intent="h2">#{item.number}: {item.subject}</Typography>
                    ...
                    <SectionCard>
                      ...
                      <FieldGrid>
                        <FieldCellWide>
                          ...
                          <Typography intent="body">{item.subject}</Typography>
                        </FieldCellWide>
                        <FieldCell>
                        ...
                        <FieldCell>
                          <Typography intent="label" style={{ fontWeight: 600 }}>From</Typography>
                          <Typography intent="body">{item.from}</Typography>
                        </FieldCell>
                        <FieldCell>
                          <Typography intent="label" style={{ fontWeight: 600 }}>Date</Typography>
                          <Typography intent="body">{item.date}</Typography>
                        </FieldCell>
                      </FieldGrid>
                    </SectionCard>
