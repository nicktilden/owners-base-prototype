...
import { FileCurrencyUSA as InvoicingIcon, Filter, Plus, Sliders } from "@procore/core-icons";
...
interface GroupByOption {
  id: "vendor" | "status" | "billingPeriod";
  label: string;
}
          ...
          <SplitViewCard.Section heading="Invoices">
            ...
            <GridArea>
              ...
              <div style={{ flex: 1, minWidth: 0, transition: "flex 0.25s ease" }}>
                <SmartGridWrapper
                  id="invoicing-grid"
                  localStorageKey="owner-prototype-invoicing-grid"
                  height="100%"
