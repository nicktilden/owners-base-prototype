...
const SECTIONS: SettingSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: <Warning size="sm" />,     iconColor: 'var(--color-pill-bg-yellow)', title: 'Health & Risk Configuration', description: 'Active KPIs, score thresholds, scoring templates, and scope', href: '/settings/health-risk', badge: 'New' },
